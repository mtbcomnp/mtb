...
const RESOURCES = [
  {
    ...
    desc: "An Excel Add-ins to converts dates between Bikram Sambat (BS) and English Gregorian (AD) calendars and vice versa. A fast, accurate tool for auditors, accountant, and excel users.",
    category: "Xlam",
    tags: ["Excel Add-ins", "Date Converter", "AD TO BS", "BS TO AD"],
    downloadUrl: "https://drive.mtb.com.np/Skydateconverter",
    previewUrl: "https://upload.mtb.com.np/preview/skydateconverter",
    date: "2024-01-10",
    featured: true,
  },
  {
    ...
    desc: "An Accounting software design specifically for small and meduim scale business and importing industries. ",
    category: "Busywin21 Rel 9.7",
    tags: ["Busy infotech", "Busy 21", "Busywin"],
    downloadUrl: "https://drive.mtb.com.np/Busywin21_v9.7",
    previewUrl: "https://upload.mtb.com.np/preview/busywin21v9.7",
    date: "2024-01-10",
    featured: true,
  },
  {
    ...
    desc: "Generates Annex-13 / balance confirmation letters for multiple parties at once from a single data file. Saves accountants and auditors hours of manual work during auditing process. Adopted from CA Bigen Thapa.",
  ...
  },
  {
    ...
    desc: "A Busy add-on for Busy Accounting Software that adds Bikram Sambat dates alongside English dates on vouchers, invoices, and reports. Lets Nepali businesses keep their books in the local calendar without manual conversion.",
    category: "BDS FILE",
    tags: ["Nepali Miti", "BDS"],
    downloadUrl: "https://drive.mtb.com.np/BusyNepaliMiti",
    previewUrl: "https://upload.mtb.com.np/preview/busynepalimiti",
    date: "2024-02-20",
    featured: true,
  },
  {
    id: 5,
    title: "GenP",
    desc: "Creative Cloud Product patcher",
  ...
  },
  {
    ...
    desc: "A Nepali Bikram Sambat (BS) add-on for Tally, bringing BS dates into vouchers, invoices, and reports alongside the English date. Lets Tally users in Nepal keep their books in the local calendar.",
    category: "TCP",
    tags: ["Tally Add-ons", "TDL","TCP"],
    downloadUrl: "https://drive.mtb.com.np/TallyNepaliMiti",
    previewUrl: "https://upload.mtb.com.np/preview/tallynepalimiti",
    date: "2024-03-15",
    featured: true,
  },
];
